...
void main ()
{
  ...
  lowp vec4 c_4;
  c_4.xyz = ((tmpvar_3 * _LightColor0.xyz) * (max (0.0, dot (xlv_TEXCOORD2, _WorldSpaceLightPos0.xyz)) * 2.0));
  c_4.w = 0.0;
  c_1.w = c_4.w;
  c_1.xyz = (c_4.xyz + (tmpvar_3 * xlv_TEXCOORD3));
...
void main ()
{
  ...
  tmpvar_3 = tmpvar_8;
  c_1.xyz = ((texture2D (_MainTex, xlv_TEXCOORD0).xyz * 0.5) * min ((2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD2).xyz), vec3((tmpvar_3 * 2.0))));
  c_1.w = 0.0;
  c_1.xyz = (c_1.xyz + textureCube (_Cube, tmpvar_2).xyz);
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  shadow_4 = tmpvar_6;
  lowp vec4 c_7;
  c_7.xyz = ((tmpvar_3 * _LightColor0.xyz) * ((max (0.0, dot (xlv_TEXCOORD2, _WorldSpaceLightPos0.xyz)) * shadow_4) * 2.0));
  c_7.w = 0.0;
  c_1.w = c_7.w;
...
void main ()
{
  ...
  shadow_3 = tmpvar_5;
  c_1.xyz = ((texture2D (_MainTex, xlv_TEXCOORD0).xyz * 0.5) * min ((2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD2).xyz), vec3((shadow_3 * 2.0))));
  c_1.w = 0.0;
  c_1.xyz = (c_1.xyz + textureCube (_Cube, tmpvar_2).xyz);
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  lowp vec4 c_5;
  c_5.xyz = (((texture2D (_MainTex, xlv_TEXCOORD0).xyz * 0.5) * _LightColor0.xyz) * ((max (0.0, dot (xlv_TEXCOORD1, lightDir_2)) * texture2D (_LightTexture0, vec2(tmpvar_4)).w) * 2.0));
  c_5.w = 0.0;
  c_1.xyz = c_5.xyz;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  lowp vec4 c_3;
  c_3.xyz = (((texture2D (_MainTex, xlv_TEXCOORD0).xyz * 0.5) * _LightColor0.xyz) * (max (0.0, dot (xlv_TEXCOORD1, lightDir_2)) * 2.0));
  c_3.w = 0.0;
  c_1.xyz = c_3.xyz;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  lowp vec4 c_7;
  c_7.xyz = (((texture2D (_MainTex, xlv_TEXCOORD0).xyz * 0.5) * _LightColor0.xyz) * ((max (0.0, dot (xlv_TEXCOORD1, lightDir_2)) * atten_6) * 2.0));
  c_7.w = 0.0;
  c_1.xyz = c_7.xyz;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  tmpvar_4 = dot (xlv_TEXCOORD3, xlv_TEXCOORD3);
  lowp vec4 c_5;
  c_5.xyz = (((texture2D (_MainTex, xlv_TEXCOORD0).xyz * 0.5) * _LightColor0.xyz) * ((max (0.0, dot (xlv_TEXCOORD1, lightDir_2)) * (texture2D (_LightTextureB0, vec2(tmpvar_4)).w * textureCube (_LightTexture0, xlv_TEXCOORD3).w)) * 2.0));
  c_5.w = 0.0;
  c_1.xyz = c_5.xyz;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  lightDir_2 = xlv_TEXCOORD2;
  lowp vec4 c_3;
  c_3.xyz = (((texture2D (_MainTex, xlv_TEXCOORD0).xyz * 0.5) * _LightColor0.xyz) * ((max (0.0, dot (xlv_TEXCOORD1, lightDir_2)) * texture2D (_LightTexture0, xlv_TEXCOORD3).w) * 2.0));
  c_3.w = 0.0;
  c_1.xyz = c_3.xyz;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  lowp vec3 tmpvar_5;
  tmpvar_5 = (texture2D (_MainTex, xlv_TEXCOORD0).xyz * 0.5);
  lowp vec4 tmpvar_6;
...
void main ()
{
  ...
  lowp vec3 tmpvar_8;
  tmpvar_8 = (texture2D (_MainTex, xlv_TEXCOORD0).xyz * 0.5);
  lowp vec4 tmpvar_9;
