...
void main ()
{
  ...
  highp vec3 texel_4;
  lowp vec3 tmpvar_5;
  tmpvar_5 = (texture2D (_MainTex, xlv_TEXCOORD0).xyz * 0.35);
  texel_4 = tmpvar_5;
  highp vec3 tmpvar_6;
  tmpvar_6 = vec3(dot (texel_4, vec3(0.35, 0.35, 0.35)));
  tmpvar_3 = tmpvar_6;
  lowp vec4 c_7;
  c_7.xyz = ((tmpvar_3 * _LightColor0.xyz) * (max (0.0, dot (xlv_TEXCOORD2, _WorldSpaceLightPos0.xyz)) * 2.0));
  c_7.w = 0.0;
  c_1.w = c_7.w;
  c_1.xyz = (c_7.xyz + (tmpvar_3 * xlv_TEXCOORD3));
...
void surf( in Input IN, inout SurfaceOutput o ) {
    #line 392
    highp vec3 texel = (texture( _MainTex, IN.uv_MainTex).xyz * 0.35);
    o.Albedo = vec3( dot( texel, vec3( 0.35, 0.35, 0.35)));
...
void main ()
{
  ...
  tmpvar_7 = tmpvar_12;
  lowp vec4 c_13;
  c_13.xyz = ((tmpvar_3 * _LightColor0.xyz) * ((max (0.0, dot (xlv_TEXCOORD2, _WorldSpaceLightPos0.xyz)) * tmpvar_7) * 2.0));
  c_13.w = 0.0;
  c_1.w = c_13.w;
  c_1.xyz = (c_13.xyz + (tmpvar_3 * xlv_TEXCOORD3));
  c_1.xyz = (c_1.xyz + textureCube (_Cube, tmpvar_2).xyz);
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_7 = tmpvar_12;
  c_1.xyz = (tmpvar_3 * min ((2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD2).xyz), vec3((tmpvar_7 * 2.0))));
  c_1.w = 0.0;
  c_1.xyz = (c_1.xyz + textureCube (_Cube, tmpvar_2).xyz);
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  shadow_7 = tmpvar_9;
  lowp vec4 c_10;
  c_10.xyz = ((tmpvar_3 * _LightColor0.xyz) * ((max (0.0, dot (xlv_TEXCOORD2, _WorldSpaceLightPos0.xyz)) * shadow_7) * 2.0));
  c_10.w = 0.0;
  c_1.w = c_10.w;
...
void main ()
{
  ...
  tmpvar_9 = (_LightShadowData.x + (tmpvar_8 * (1.0 - _LightShadowData.x)));
  shadow_7 = tmpvar_9;
  c_1.xyz = (tmpvar_3 * min ((2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD2).xyz), vec3((shadow_7 * 2.0))));
  c_1.w = 0.0;
  c_1.xyz = (c_1.xyz + textureCube (_Cube, tmpvar_2).xyz);
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  lowp vec4 c_9;
  c_9.xyz = ((tmpvar_3 * _LightColor0.xyz) * ((max (0.0, dot (xlv_TEXCOORD1, lightDir_2)) * texture2D (_LightTexture0, vec2(tmpvar_8)).w) * 2.0));
  c_9.w = 0.0;
  c_1.xyz = c_9.xyz;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  lowp vec4 c_7;
  c_7.xyz = ((tmpvar_3 * _LightColor0.xyz) * (max (0.0, dot (xlv_TEXCOORD1, lightDir_2)) * 2.0));
  c_7.w = 0.0;
  c_1.xyz = c_7.xyz;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  lowp vec4 c_11;
  c_11.xyz = ((tmpvar_3 * _LightColor0.xyz) * ((max (0.0, dot (xlv_TEXCOORD1, lightDir_2)) * atten_10) * 2.0));
  c_11.w = 0.0;
  c_1.xyz = c_11.xyz;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  tmpvar_8 = dot (xlv_TEXCOORD3, xlv_TEXCOORD3);
  lowp vec4 c_9;
  c_9.xyz = ((tmpvar_3 * _LightColor0.xyz) * ((max (0.0, dot (xlv_TEXCOORD1, lightDir_2)) * (texture2D (_LightTextureB0, vec2(tmpvar_8)).w * textureCube (_LightTexture0, xlv_TEXCOORD3).w)) * 2.0));
  c_9.w = 0.0;
  c_1.xyz = c_9.xyz;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  lightDir_2 = xlv_TEXCOORD2;
  lowp vec4 c_7;
  c_7.xyz = ((tmpvar_3 * _LightColor0.xyz) * ((max (0.0, dot (xlv_TEXCOORD1, lightDir_2)) * texture2D (_LightTexture0, xlv_TEXCOORD3).w) * 2.0));
  c_7.w = 0.0;
  c_1.xyz = c_7.xyz;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  highp vec3 texel_6;
  lowp vec3 tmpvar_7;
  tmpvar_7 = (texture2D (_MainTex, xlv_TEXCOORD0).xyz * 0.35);
  texel_6 = tmpvar_7;
  highp vec3 tmpvar_8;
  tmpvar_8 = vec3(dot (texel_6, vec3(0.35, 0.35, 0.35)));
  tmpvar_5 = tmpvar_8;
  lowp vec4 tmpvar_9;
  tmpvar_9 = textureCube (_Cube, tmpvar_4);
  lowp vec4 tmpvar_10;
  ...
  lowp vec4 c_13;
  mediump vec3 tmpvar_14;
  tmpvar_14 = (tmpvar_5 * light_3.xyz);
  c_13.xyz = tmpvar_14;
  c_13.w = 0.0;
  c_2 = c_13;
  c_2.xyz = (c_2.xyz + tmpvar_9.xyz);
  tmpvar_1 = c_2;
...
void main ()
{
  ...
  highp vec3 texel_9;
  lowp vec3 tmpvar_10;
  tmpvar_10 = (texture2D (_MainTex, xlv_TEXCOORD0).xyz * 0.35);
  texel_9 = tmpvar_10;
  highp vec3 tmpvar_11;
  tmpvar_11 = vec3(dot (texel_9, vec3(0.35, 0.35, 0.35)));
  tmpvar_8 = tmpvar_11;
  lowp vec4 tmpvar_12;
  tmpvar_12 = textureCube (_Cube, tmpvar_7);
  lowp vec4 tmpvar_13;
  ...
  tmpvar_19 = (tmpvar_8 * light_6.xyz);
  c_18.xyz = tmpvar_19;
  c_18.w = 0.0;
  c_2 = c_18;
  c_2.xyz = (c_2.xyz + tmpvar_12.xyz);
  tmpvar_1 = c_2;
  gl_FragData[0] = tmpvar_1;
}
...
void main ()
{
  ...
  lowp vec4 c_15;
  mediump vec3 tmpvar_16;
  tmpvar_16 = (tmpvar_5 * tmpvar_14.xyz);
  c_15.xyz = tmpvar_16;
  c_15.w = 0.0;
  c_2 = c_15;
  c_2.xyz = (c_2.xyz + tmpvar_9.xyz);
