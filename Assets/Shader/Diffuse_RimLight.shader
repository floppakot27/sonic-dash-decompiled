...
void main ()
{
  ...
  tmpvar_8 = (_RimColor.xyz * pow ((1.0 - clamp (dot (normalize(tmpvar_3), xlv_TEXCOORD2), 0.0, 1.0)), _RimPower));
  tmpvar_5 = tmpvar_8;
  lowp vec4 c_9;
  c_9.xyz = ((tmpvar_4 * _LightColor0.xyz) * (max (0.0, dot (xlv_TEXCOORD2, _WorldSpaceLightPos0.xyz)) * 2.0));
  c_9.w = 0.0;
  c_1.w = c_9.w;
...
void surf( in Input IN, inout SurfaceOutput o ) {
    #line 394
    o.Albedo = (texture( _MainTex, IN.uv_MainTex).xyz * IN.color.xyz);
...
void main ()
{
  ...
  tmpvar_8 = (_RimColor.xyz * pow ((1.0 - clamp (dot (normalize(tmpvar_3), xlv_TEXCOORD2), 0.0, 1.0)), _RimPower));
  tmpvar_5 = tmpvar_8;
  c_1.xyz = (tmpvar_4 * (2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD3).xyz));
  c_1.w = 0.0;
  c_1.xyz = (c_1.xyz + tmpvar_5);
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_9 = tmpvar_14;
  lowp vec4 c_15;
  c_15.xyz = ((tmpvar_4 * _LightColor0.xyz) * ((max (0.0, dot (xlv_TEXCOORD2, _WorldSpaceLightPos0.xyz)) * tmpvar_9) * 2.0));
  c_15.w = 0.0;
  c_1.w = c_15.w;
...
void main ()
{
  ...
  tmpvar_14 = max (float((dist_11 > (xlv_TEXCOORD4.z / xlv_TEXCOORD4.w))), lightShadowDataX_10);
  tmpvar_9 = tmpvar_14;
  c_1.xyz = (tmpvar_4 * min ((2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD3).xyz), vec3((tmpvar_9 * 2.0))));
  c_1.w = 0.0;
  c_1.xyz = (c_1.xyz + tmpvar_5);
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_18 = (tmpvar_4 * min (lm_15, tmpvar_17));
  c_1.xyz = tmpvar_18;
  c_1.w = 0.0;
  c_1.xyz = (c_1.xyz + tmpvar_5);
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  shadow_9 = tmpvar_11;
  lowp vec4 c_12;
  c_12.xyz = ((tmpvar_4 * _LightColor0.xyz) * ((max (0.0, dot (xlv_TEXCOORD2, _WorldSpaceLightPos0.xyz)) * shadow_9) * 2.0));
  c_12.w = 0.0;
  c_1.w = c_12.w;
...
void main ()
{
  ...
  tmpvar_11 = (_LightShadowData.x + (tmpvar_10 * (1.0 - _LightShadowData.x)));
  shadow_9 = tmpvar_11;
  c_1.xyz = (tmpvar_4 * min ((2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD3).xyz), vec3((shadow_9 * 2.0))));
  c_1.w = 0.0;
  c_1.xyz = (c_1.xyz + tmpvar_5);
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_15 = (tmpvar_4 * min (lm_12, tmpvar_14));
  c_1.xyz = tmpvar_15;
  c_1.w = 0.0;
  c_1.xyz = (c_1.xyz + tmpvar_5);
  gl_FragData[0] = c_1;
...
"!!GLES3"
 ...
 Pass {
  Name "FORWARD"
  Tags { "LIGHTMODE"="ForwardAdd" "QUEUE"="Geometry+2" "RenderType"="Opaque" }
  ZWrite Off
  Fog {
   Color (0,0,0,0)
  }
...
void main ()
{
  ...
  tmpvar_6 = (tmpvar_5.xyz * tmpvar_3.xyz);
  tmpvar_4 = tmpvar_6;
  mediump vec3 tmpvar_7;
  ...
  lowp vec4 c_9;
  c_9.xyz = ((tmpvar_4 * _LightColor0.xyz) * ((max (0.0, dot (xlv_TEXCOORD1, lightDir_2)) * texture2D (_LightTexture0, vec2(tmpvar_8)).w) * 2.0));
  c_9.w = 0.0;
  c_1.xyz = c_9.xyz;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  lowp vec4 c_7;
  c_7.xyz = ((tmpvar_4 * _LightColor0.xyz) * (max (0.0, dot (xlv_TEXCOORD1, lightDir_2)) * 2.0));
  c_7.w = 0.0;
  c_1.xyz = c_7.xyz;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  lowp vec4 c_11;
  c_11.xyz = ((tmpvar_4 * _LightColor0.xyz) * ((max (0.0, dot (xlv_TEXCOORD1, lightDir_2)) * atten_10) * 2.0));
  c_11.w = 0.0;
  c_1.xyz = c_11.xyz;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  tmpvar_8 = dot (xlv_TEXCOORD3, xlv_TEXCOORD3);
  lowp vec4 c_9;
  c_9.xyz = ((tmpvar_4 * _LightColor0.xyz) * ((max (0.0, dot (xlv_TEXCOORD1, lightDir_2)) * (texture2D (_LightTextureB0, vec2(tmpvar_8)).w * textureCube (_LightTexture0, xlv_TEXCOORD3).w)) * 2.0));
  c_9.w = 0.0;
  c_1.xyz = c_9.xyz;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  lightDir_2 = xlv_TEXCOORD2;
  lowp vec4 c_7;
  c_7.xyz = ((tmpvar_4 * _LightColor0.xyz) * ((max (0.0, dot (xlv_TEXCOORD1, lightDir_2)) * texture2D (_LightTexture0, xlv_TEXCOORD3).w) * 2.0));
  c_7.w = 0.0;
  c_1.xyz = c_7.xyz;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  tmpvar_12.w = 1.0;
  tmpvar_12.xyz = (tmpvar_11 * (tmpvar_2 * unity_Scale.w));
  ...
  tmpvar_31 = (tmpvar_30 * (tmpvar_2 * unity_Scale.w));
  tmpvar_4 = tmpvar_31;
  ...
  xlv_TEXCOORD1 = (tmpvar_30 * (((_World2Object * tmpvar_32).xyz * unity_Scale.w) - _glesVertex.xyz));
  xlv_COLOR0 = _glesColor;
  xlv_TEXCOORD2 = o_8;
  xlv_TEXCOORD3 = tmpvar_4;
...
void main ()
{
  ...
  mediump vec3 tmpvar_9;
  tmpvar_9 = (tmpvar_8.xyz * tmpvar_4.xyz);
  tmpvar_6 = tmpvar_9;
  mediump vec3 tmpvar_10;
  tmpvar_10 = (_RimColor.xyz * pow ((1.0 - clamp (dot (normalize(tmpvar_5), xlv_TEXCOORD3), 0.0, 1.0)), _RimPower));
  tmpvar_7 = tmpvar_10;
  lowp vec4 tmpvar_11;
...
void main ()
{
  ...
  gl_Position = tmpvar_6;
  xlv_TEXCOORD0 = tmpvar_3;
  xlv_TEXCOORD1 = (tmpvar_13 * (((_World2Object * tmpvar_15).xyz * unity_Scale.w) - _glesVertex.xyz));
  xlv_COLOR0 = _glesColor;
  xlv_TEXCOORD2 = o_8;
  xlv_TEXCOORD3 = tmpvar_4;
...
void main ()
{
  ...
  tmpvar_12 = (tmpvar_11.xyz * tmpvar_7.xyz);
  tmpvar_9 = tmpvar_12;
  mediump vec3 tmpvar_13;
  tmpvar_13 = (_RimColor.xyz * pow ((1.0 - clamp (dot (normalize(tmpvar_8), xlv_TEXCOORD3), 0.0, 1.0)), _RimPower));
  tmpvar_10 = tmpvar_13;
  lowp vec4 tmpvar_14;
