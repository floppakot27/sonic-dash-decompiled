...
void main ()
{
  ...
  highp vec4 Tex2D0_4;
  lowp vec4 tmpvar_5;
  tmpvar_5 = texture2D (_Alpha, xlv_TEXCOORD0);
  Tex2D0_4 = tmpvar_5;
  highp vec3 tmpvar_6;
  tmpvar_6 = ((Tex2D0_4.wwww + pow (vec4((1.0 - dot (normalize(xlv_TEXCOORD1), normalize(vec3(0.0, 0.0, 1.0))))), vec4(_FresnelExponent))) * tmpvar_2).xyz;
  tmpvar_3 = tmpvar_6;
...
v2f_surf vert_surf( in appdata_full v ) {
    ...
    o.pack0.xy = ((v.texcoord.xy * _Alpha_ST.xy) + _Alpha_ST.zw);
    #line 484
    o.color = v.color;
...
void surf( in Input IN, inout EditorSurfaceOutput o ) {
    ...
    o.Specular = 0.0;
    o.Custom = vec4( 0.0);
    highp vec4 Tex2D0 = texture( _Alpha, IN.uv_Alpha.xyxy.xy);
    #line 451
    ...
    highp vec4 Add0 = (Tex2D0.wwww + Pow0);
    #line 455
    highp vec4 Multiply0 = (Add0 * IN.color);
    ...
    #line 463
    o.Emission = vec3( Multiply0);
    o.Normal = normalize(o.Normal);
}
#line 497
lowp vec4 frag_surf( in v2f_surf IN ) {
    Input surfIN;
    surfIN.uv_Alpha = IN.pack0.xy;
    #line 501
...
void main ()
{
  ...
  highp vec4 Tex2D0_6;
  lowp vec4 tmpvar_7;
  tmpvar_7 = texture2D (_Alpha, xlv_TEXCOORD0);
  Tex2D0_6 = tmpvar_7;
  highp vec3 tmpvar_8;
  tmpvar_8 = ((Tex2D0_6.wwww + pow (vec4((1.0 - dot (normalize(xlv_TEXCOORD1), normalize(vec3(0.0, 0.0, 1.0))))), vec4(_FresnelExponent))) * tmpvar_4).xyz;
  tmpvar_5 = tmpvar_8;
  lowp vec4 tmpvar_9;
...
void main ()
{
  ...
  Tex2D0_9 = tmpvar_10;
  highp vec3 tmpvar_11;
  tmpvar_11 = ((Tex2D0_9.wwww + pow (vec4((1.0 - dot (normalize(xlv_TEXCOORD1), normalize(vec3(0.0, 0.0, 1.0))))), vec4(_FresnelExponent))) * tmpvar_7).xyz;
  tmpvar_8 = tmpvar_11;
  lowp vec4 tmpvar_12;
