...
public class Dialog_WOFReward : MonoBehaviour
{
	...
	private const string JackpotTitle = "DIALOG_WHEEL_NORMAL_PRIZE_TITLE";

	private const string JackpotReason = "DIALOG_WHEEL_NORMAL_PRIZE_BODY";
	...
	public static void Display(StoreContent.StoreEntry prize, int quantity)
	{
		s_prize = prize;
		s_quantity = quantity;
		DialogStack.ShowDialog("Daily Spin Dialog");
	}
	...
	private void UpdateContent()
	{
		...
		{
			m_titleObject.text = LanguageStrings.First.GetString("DIALOG_WHEEL_NORMAL_PRIZE_TITLE");
			m_reasonObject.text = LanguageStrings.First.GetString("DIALOG_WHEEL_NORMAL_PRIZE_BODY");
